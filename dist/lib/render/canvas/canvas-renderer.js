...
var CanvasRenderer = /** @class */ (function (_super) {
    ...
    CanvasRenderer.prototype.renderTextNode = function (text, styles) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, font, fontFamily, fontSize, adorWidth, xnwi, adorLeft, adorTop, adorHeight, _b, baseline, middle, paintOrder;
            var _this = this;
            return __generator(this, function (_c) {
                _a = this.createFontStyle(styles), font = _a[0], fontFamily = _a[1], fontSize = _a[2];
                adorWidth = 0;
                for (xnwi = 0; xnwi < text.textBounds.length; xnwi++) {
                ...
                text.textBounds.forEach(function (text) {
                    paintOrder.forEach(function (paintOrderLayer) {
                        switch (paintOrderLayer) {
                            case 0 /* FILL */:
                                var bgImage = styles.backgroundImage[0];
                                if (styles.backgroundClip[0] == 3 /* TEXT */ && image_1.isLinearGradient(bgImage)) {
                                    if (styles.backgroundImage[0] === undefined) {
                                        _this.ctx.fillStyle = color_1.asString(styles.backgroundColor);
                                    }
                                    else {
                                        var _a = gradient_1.calculateGradientDirection(bgImage.angle, adorWidth, adorHeight), lineLength = _a[0], x0 = _a[1], x1 = _a[2], y0 = _a[3], y1 = _a[4];
                                        var canvas = document.createElement('canvas');
                                        canvas.width = adorWidth;
                                        canvas.height = adorHeight;
                                        var xctx = canvas.getContext('2d');
                                        var gradient_2 = xctx.createLinearGradient(adorLeft + x0, adorTop + y0, adorLeft + x1, adorTop + y1);
                                        gradient_1.processColorStops(bgImage.stops, lineLength).forEach(function (colorStop) {
                                            return gradient_2.addColorStop(colorStop.stop, color_1.asString(colorStop.color));
                                        });
                                        _this.ctx.fillStyle = gradient_2;
                                    }
                                }
                                else {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        _loop_1 = function (backgroundImage) {
                            var image, url, e_4, _c, path, x, y, width, height, pattern, _d, path, x, y, width, height, canvas, ctx, pattern, _e, path, x, y, width, height, _f, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_3, pattern, _g, path, left, top_1, width, height, position, x, y, _h, rx, ry, radialGradient_1, midX, midY, f, invF;
                            return __generator(this, function (_j) {
                                switch (_j.label) {
                                    ...
                                    case 4:
                                        ...
                                        return [3 /*break*/, 6];
                                    case 5:
                                        if (container.styles.backgroundClip[0] == 3 /* TEXT */) {
                                            ...
                                            _e = background_1.calculateBackgroundRendering(container, index, [null, null, null]), path = _e[0], x = _e[1], y = _e[2], width = _e[3], height = _e[4];
                                            _f = gradient_1.calculateGradientDirection(backgroundImage.angle, width, height), lineLength = _f[0], x0 = _f[1], x1 = _f[2], y0 = _f[3], y1 = _f[4];
                                            canvas = document.createElement('canvas');
                                            canvas.width = width;
                                            canvas.height = height;
                                            ctx = canvas.getContext('2d');
                                            ...
                                            gradient_1.processColorStops(backgroundImage.stops, lineLength).forEach(function (colorStop) {
                                                return gradient_3.addColorStop(colorStop.stop, color_1.asString(colorStop.color));
                                            });
                                            ...
                                            _g = background_1.calculateBackgroundRendering(container, index, [
                                                null,
                                                null,
                                                null
                                            ]), path = _g[0], left = _g[1], top_1 = _g[2], width = _g[3], height = _g[4];
                                            ...
                                            _h = gradient_1.calculateRadius(backgroundImage, x, y, width, height), rx = _h[0], ry = _h[1];
                                            if (rx > 0 && ry > 0) {
